January 2022, Author's note: This code was started as a credentials platform (SSI) - see the older commits. It evolved into a Defi Vault (Laguna) for the Solana Season hackathon Summer 2021 before I stopped working on it. It's now public source, closed license to serve as an example (and perhaps platform) for creating new Solana Defi projects.
